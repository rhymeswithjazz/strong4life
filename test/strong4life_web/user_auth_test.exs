defmodule Strong4lifeWeb.UserAuthTest do
  use Strong4lifeWeb.ConnCase, async: true

  alias Strong4life.Accounts
  alias Strong4life.Accounts.Scope
  alias Strong4lifeWeb.UserAuth

  import Strong4life.AccountsFixtures

  @remember_me_cookie "_strong4life_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Strong4lifeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
